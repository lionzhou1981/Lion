...
using Lion.Drawing.QRCode;
using System.Drawing;
using System.Drawing.Drawing2D;

namespace Lion.Drawing
{
    public class QRCoder : IDisposable
    {
        ...
        private static Bitmap GetGraphic(QRCodeData _data, int pixelsPerModule, Color darkColor, Color lightColor, Bitmap icon = null, int iconSizePercent = 15, int iconBorderWidth = 6, bool drawQuietZones = true)
        {
            var size = (_data.ModuleMatrix.Count - (drawQuietZones ? 0 : 8)) * pixelsPerModule;
            ...
            using (var darkBrush = new SolidBrush(darkColor))
            {
                ...
                for (var x = 0; x < size + offset; x = x + pixelsPerModule)
                {
                    ...
                    {
                        var module = _data.ModuleMatrix[(y + pixelsPerModule) / pixelsPerModule - 1][(x + pixelsPerModule) / pixelsPerModule - 1];
        ...
        private static QRCodeData CreateQrCode(PayloadGenerator.Payload payload)
        {
        ...
        /// <exception cref="QRCoder.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        private static QRCodeData CreateQrCode(PayloadGenerator.Payload payload, ECCLevel eccLevel)
        {
        ...
        /// <exception cref="QRCoder.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        private static QRCodeData CreateQrCode(string plainText, ECCLevel eccLevel, bool forceUtf8 = false, bool utf8BOM = false, EciMode eciMode = EciMode.Default, int requestedVersion = -1)
        {
        ...
        /// <exception cref="QRCoder.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        private static QRCodeData CreateQrCode(byte[] binaryData, ECCLevel eccLevel)
        {
        ...
        /// <exception cref="QRCoder.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        private static QRCodeData GenerateQrCode(PayloadGenerator.Payload payload)
        {
        ...
        /// <exception cref="QRCoder.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        private static QRCodeData GenerateQrCode(PayloadGenerator.Payload payload, ECCLevel eccLevel)
        {
        ...
        /// <exception cref="QRCoder.Exceptions.DataTooLongException">Thrown when the payload is too big to be encoded in a QR code.</exception>
        /// <returns>Returns the raw QR code data which can be used for rendering.</returns>
        private static QRCodeData GenerateQrCode(byte[] binaryData, ECCLevel eccLevel)
        {
