...
namespace Lion.Drawing.QRCode
{
    public static class PayloadGenerator
    {
        public abstract class Payload
        {
            ...
            public virtual QRCoder.ECCLevel EccLevel { get { return QRCoder.ECCLevel.M; } }
            public virtual QRCoder.EciMode EciMode { get { return QRCoder.EciMode.Default; } }
        ...
        public class OneTimePassword : Payload
        {
            ...
            {
                if (CheckIsNullOrWhiteSpace(Secret))
                {
                ...
                if (!CheckIsNullOrWhiteSpace(Issuer))
                {
                    if (Issuer.Contains(":"))
                    {
                ...
                if (!CheckIsNullOrWhiteSpace(Label))
                {
                    if (Label.Contains(":"))
                    {
        ...
        public class SlovenianUpnQr : Payload
        {
            ...
            public override QRCoder.ECCLevel EccLevel { get { return QRCoder.ECCLevel.M; } }
            public override QRCoder.EciMode EciMode { get { return QRCoder.EciMode.Iso8859_2; } }
        ...
        public static bool CheckIsNullOrWhiteSpace(String value)
        {
