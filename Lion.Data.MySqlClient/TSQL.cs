...
namespace Lion.Data.MySqlClient
{
    ...
    public class TSQL
    {
        ...
        public MySqlCommand ToSqlCommand()
        {
            ...
            switch (this.Type)
            {
                ...
                case TSQLType.Delete:
                    _sql = "DELETE FROM " + GetSqlTable(this, ref _return);
                    _sql += GetSqlOutput(this);
                    _sql += this.Wheres.Count > 0 ? " WHERE " + GetSqlWhere(this.Wheres, ref _return) : "";
                    break;
                case TSQLType.Select:
                    ...
                    _sql += (this.Limit > 0 ? (" LIMIT " + this.Limit.ToString()) : "");
                    _sql += (this.Offset > 0 ? (" OFFSET " + this.Offset.ToString()) : "");
                    break;
        ...
        #region TableString
        #region GetSqlTable
        private string GetSqlTable(TSQL _tsql, ref MySqlCommand _sqlCommand)
        {
            string _return = "";
                    ...
                    if (_index > 0)
                    {
                        switch (_table.Relation)
                        {
                            ...
                            case TableRelation.FullOuter:
                                throw new Exception("暂不支持FULL JOIN！");
                               // _return += " LEFT OUTER JOIN ";
                               // _return += GetSqlTableNameString(_table) + " ON " + GetSqlWhere(_table.Conditions, ref _sqlCommand);
                               //_return += " UNION ";
                               // _return +=  "SELECT ";
        ...
        private string GetSqlInsertValue(TSQL _tsql, ref MySqlCommand _sqlCommand)
        {
            string _return = "";
            for (int _index = 0; _index < _tsql.Fields.Count; _index++)
            {
        ...
        private string GetSqlUpdateField(TSQL _tsql, ref MySqlCommand _sqlCommand)
        {
            string _return = "";
            for (int _index = 0; _index < _tsql.Fields.Count; _index++)
            {
                ...
                if (_field.AsName != "_ThisIsCustomField_")
                {
                    ...
                    {
                        MySqlParameter _sqlParameter = _sqlCommand.Parameters.AddWithValue("@" + _field.Name.Replace(".", "_"), _field.DbType);
        ...
        private string GetSqlOutput(TSQL _tsql)
        {
            ...
            for (int i = 0; i < _tsql.Outputs.Count; i++)
            {
                ...
                switch (_tsql.Outputs[i].Type)
                {
                    ...
                    case OutputType.Deleted:throw new Exception("删除不需要添加OutPut参数");// _output += " OUTPUT DELETED."; break;
                }
        ...
        #region WhereString
        private string GetSqlWhere(IList<Where> _wheres, ref MySqlCommand _sqlCommand)
        {
            string _return = "";
        ...
        #region HavingString
        private string GetSqlHaving(TSQL _tsql, ref MySqlCommand _sqlCommand)
        {
        ...
        private string GetParameter(IList<Parameter> _parameters, ref MySqlCommand _sqlCommand)
        {
            string _return = "";
        ...
        private string GetExpression(ExpressionMode _expressionMode, ExpressionRelation _expressionRelation, object _fieldObject1, object _fieldObject2, object _fieldObject3, ref MySqlCommand _sqlCommand, Random _random)
        {
            string _return = "";
            ...
            if (_expressionRelation != ExpressionRelation.Custom)
            {
                switch (_expressionMode)
                {
                    ...
                    case ExpressionMode.FieldVsValue:
                        ...
                        {
                            MySqlParameter _sqlParameter = new MySqlParameter(_field2, SqlDbType.UniqueIdentifier);
                            _sqlParameter.Value = _fieldObject2;
                            _sqlCommand.Parameters.Add(_sqlParameter);
                        }
                        else
